...
The following organizations and projects are using Identus in production or active development.
...
| [Trust0](https://github.com/trust0-project) | Engineering consultancy building decentralized identity solutions using SSI protocols, zero-knowledge proofs, and distributed ledger technologies. |

## How to add your organization

If your organization or project uses Identus, we encourage you to add it here! Please submit a pull request with a new row in the table above using the following format:

```markdown
| [Organization Name](https://example.com) | Brief description of how you use Identus. |
```
